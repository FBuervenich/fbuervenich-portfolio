  ...
  data: function () {
    return {
      imprintParts: [
        ...
        { heading: 'Vertreten durch:', paragraphs: ['Florentin Bürvenich'] },
        { heading: 'Kontakt:', paragraphs: ['fbuervenich@pm.me'] },
        {
          heading: 'Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV:',
          paragraphs: ['Florentin Bürvenich', 'fbuervenich@pm.me'],
        },
        { heading: 'Haftungsausschluss:', paragraphs: [] },
        {
