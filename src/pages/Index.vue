  ...
  <Layout>
    ...
    >
      <div class="text-4xl font-bold w-full sm:w-3/5 text-center sm:text-left">
        ...
        <div class="text-red-700 leading-tight">Welcome!</div>
      </div>
    ...
    <div class="container-inner mx-auto">
      <p class="text-lg sm:text-xl">
        ...
        . I added more features and decided to release it as an open source
      ...
      <div class="contact-me bg-background-secondary pt-16">
        <div class="container-inner mx-auto text-xl pb-4 relative">
          ...
          <p class="mb-12">
            ...
            can help you do this without a backend.
          </p>
          ...
          <form action="#">
            <div class="flex flex-col sm:flex-row">
              <input
                ...
                class="flex-1 bg-background-form rounded sm:rounded-r-none px-4 py-4 leading-normal border border-border-color-primary sm:border-r-0 shadow outline-none focus:border-red-700 z-10"
                required
              />
              <button
                data-element="submit"
                class="flex-2 w-40 uppercase bg-red-700 text-white rounded sm:rounded-l-none text-lg py-3 px-8 tracking-wide shadow focus:outline-none hover:bg-green-800 focus:bg-green-800 z-10 w-full sm:w-auto mt-4 sm:mt-0"
              >
                <span>Subscribe</span>
              </button>
            </div>
